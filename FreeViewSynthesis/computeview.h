...
public:
    ...
    void pointProject_from_ref_to_otherView(int ref, int u, int v, unsigned char d);
    void warpingImage(int ref, int cam_ref, int proj, cv::Mat &imageColorOut, cv::Mat &imageDepthOut);
